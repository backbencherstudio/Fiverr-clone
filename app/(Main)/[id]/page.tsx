...
export default function GigDetail() {
  ...
  return (
    <div className="py-8">
      <GitHeader />
      <Container>
        <div className="flex max-w-7xl mx-auto justify-between gap-25">
          <section className="">
            ...
            <div className="relative border bg-[#f5f5f5] border-zinc-200 overflow-hidden py-2">
              <img
                src="/card.jpg"
                alt="Gig preview"
              ...
              <div className="bg-white border border-zinc-200 rounded-md p-6">
                ...
                <div className="mb-4">
                  <div className="text-sm text-zinc-500">
                    {tab.toUpperCase()} LEVEL DJANGO WEBSITE
                  </div>
                ...
                <div className="flex items-center gap-3 p-3 border border-zinc-200 rounded-md">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-zinc-500">
                      Hire by the hour, ideal for long-term projects with
                      flexible hours and weekly payments.
                    </div>
                    <div className="mt-2 font-semibold">
                      $29/hour{" "}
                      <a className="underline ml-3">Request hourly offer</a>
                    </div>
                  </div>
                </div>
              </div>
